    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Text('Bonus Italia', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: AppColors.textDark)),
          const SizedBox(height: 4),
          const Text('App informativa indipendente', style: TextStyle(fontSize: 13, color: AppColors.textMedium)),
          const SizedBox(height: 4),
          Text('Versione 1.0.7', style: TextStyle(fontSize: 12, color: Colors.grey.shade500)),
        ],
      ),
    );
  }
